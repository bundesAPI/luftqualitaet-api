...
from deutschland.luftqualitaet import rest
...
from deutschland.luftqualitaet.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AirqualityApi()
        api_instance.airquality_json_get  # this is an instance of the class Endpoint
        api_instance.airquality_json_get()  # this invokes api_instance.airquality_json_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.airquality_json_get.callable or self.callable in this class
