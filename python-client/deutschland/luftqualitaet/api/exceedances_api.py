...
class ExceedancesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.transgressions_json_get_endpoint = _Endpoint(
            settings={
                "response_type": (
                    bool,
                    date,
                ...
                "auth": [],
                "endpoint_path": "/transgressions/json",
                "operation_id": "transgressions_json_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def transgressions_json_get(self, component, year, **kwargs):
        """Get exceedances data  # noqa: E501

        Returns exceedances data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.transgressions_json_get(component, year, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["year"] = year
        return self.transgressions_json_get_endpoint.call_with_http_info(**kwargs)
